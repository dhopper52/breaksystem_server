...
router.post("/getCurrentBreak", authenticateUser, async (req, res) => {
...
router.post("/getBreaksDaily", authenticateUser, async (req, res) => {
...
router.post("/getBreaksMonthly", authenticateUser, async (req, res) => {
  try {
